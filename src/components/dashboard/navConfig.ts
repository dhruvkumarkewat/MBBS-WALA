...
export const mainNav: NavItem[] = [
  ...
  { label: 'Documents', path: '/dashboard/documents', icon: FolderOpen, section: 'Admissions' },
  { label: 'Downloads', path: '/dashboard/downloads', icon: CloudDownload, section: 'Admissions' },
  { label: 'Applications', path: '/dashboard/applications', icon: ClipboardList, badge: 2, section: 'Admissions' },
